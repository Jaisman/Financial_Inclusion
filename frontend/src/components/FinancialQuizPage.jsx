...
//   const { t } = useLanguage();
  ...
  const questions = [
    ...
    {
      text: 'Do you save a portion of your income?',
    ...
    {
      text: 'Have you checked your credit score recently?',
      options: ['Yes', 'No'],
      weights: { credit: [20, 0] },
      category: 'credit',
      feedback: [
          ...
          {!isComplete ? (
            ...
            <div className="text-center">
              ...
              <div className="bg-slate-700/30 rounded-2xl p-6 mb-6 border border-slate-600">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-slate-800/50 rounded-xl p-4 border border-slate-600">
                    <p className="text-sm text-gray-400">{'Credit Building'}</p>
              ...
              <p className="text-base text-gray-300 mb-6">
                {score.total >= 60
                  ?  "Great job! Keep building your financial future with our tools."
                  :  "Let's improve! Explore our educational resources and NGO programs."}
              </p>
              ...
              <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4 mb-6">
                ...
                >
                  {'Ask EduBot'} <ArrowRight className="w-4 h-4 ml-2" />
                </Link>
                <Link
                  to="/ngo"
